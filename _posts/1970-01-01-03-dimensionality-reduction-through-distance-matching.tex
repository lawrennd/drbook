...
\begin{octave}
  ...
  importTool('dimred')
  if isoctave
    addpath('/home/neil/mlprojects/matlab/m_map/private')
  end
  dimredToolboxes
  randn('seed', 1e6)
  rand('seed', 1e6)
...
handwritten six and visualize the result. In \reffig{fig:subSampleSix} we show the six sub-sampled down to an image with 16 rows and 15 columns ($\dataDim=240$). 
\begin{figure}
  \begin{octave}
  ...
  \end{octave}
  \begin{center}
    \input{../../../dimred/tex/diagrams/demSixSubSample}
  \end{center}
...
We can see from the figure that the main elements of a handwritten six
